...
console.log('Battery Mid-point:');
let batteryMidPoint = (agility.battery.minimumLevel + ((agility.battery.chargeLimit - agility.battery.minimumLevel)*0.8)); //modulate this factor (nominally 80%) as required
console.log(batteryMidPoint);
...
agility.logger.write('Battery Mid-point:');
agility.logger.write(batteryMidPoint);
console.log('AGILITY STATUS:');
console.log(obj.deficit);
console.log(status);
console.log('BATTERY RESERVE:');
console.log(obj.battery.availablePower);
console.log('BATTERY HEADROOM %:');
console.log(obj.battery.chargeLimit - obj.battery.level);
console.log('BATTERY kWh added per charge:');
console.log(obj.battery.powerAddedPerCharge);
console.log('BATTERY level over midpoint?:');
console.log(+obj.battery.level > +batteryMidPoint);
...
if ( obj.battery.level <= batteryMidPoint ) {
status = 'DEFICIT';
}
